...
readonly DWM_PKGS="$X_PKGS xorg-fonts libX11-devel libXft-devel fontconfig-devel xinit font-inconsolata-otf font-libertine-otf font-awesome xinit arandr noto-fonts-emoji font-symbola xclip xdotool xdpyinfo xdpyinfo xsetroot xset pam xss-lock xsecurelock compton dmenu feh pywal tabbed xtools lf calcurse libnotify dbus dunst sxiv neovim mpd mpc mpv ncmpcpp newsboat sc-im htop unrar unzip p7zip youtube-dl zathura zathura-djvu zathura-pdf-mupdf poppler mediainfo mediainfo atool fzf simple-mtpfs bash-completion zsh zsh-syntax-highlighting neomutt transmission scrot qrencode pamixer pulsemixer firefox steam lutris gnuplot base-devel clang tcc python python3 python3-pip ninja gromit-mpx wxMaxima octave"
